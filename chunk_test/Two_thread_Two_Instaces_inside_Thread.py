...
def worker(thread_id: int, input_queue: queue.Queue, output_queue: queue.Queue):
    logging.info(f"Thread {thread_id}: Loading model...")
    model = whisper.load_model("medium", device="cpu")
    logging.info(f"Thread {thread_id}: Model loaded.")
